package com.il.spring_mvc;

import com.il.spring_mvc.entities.Patient;
import com.il.spring_mvc.repositories.PatientRepo;
import com.il.spring_mvc.security.services.AccountService;
...
public class SpringMvcApplication  {
	...
	CommandLineRunner start(AccountService accountService) {
		return args -> {
			...
			accountService.saveUser("ilyas", "1234", "ilyas@gmail.com", "1234");
			accountService.saveUser("hamza", "1234", "hamza@gmail.Com", "1234");
			accountService.addRoleToUser("ilyas", "ADMIN");
			accountService.addRoleToUser("ilyas", "USER");
